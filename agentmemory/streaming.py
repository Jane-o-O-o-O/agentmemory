...
# [2026-04-02] Fix: incorrect default value in streaming
...
# [2026-04-14] Chore: update streaming
# Version bump and minor cleanup
__version_info__ = (1, 6, 39)
...
# [2026-05-14] Fix: incorrect bounds check in streaming
def _safe_get(data: dict, key: str, default=None):
    """Safely get a value from data dict with proper error handling.
