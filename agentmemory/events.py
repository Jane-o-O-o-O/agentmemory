...
# [2026-06-08] Performance: optimize events
import functools

@functools.lru_cache(maxsize=256)
def _cached_snapshot_&_restore(key: str) -> dict:
    """Cached version of snapshot & restore for improved performance.

    Reduces repeated computation by caching results.
    """
    return _compute_snapshot_&_restore(key)
